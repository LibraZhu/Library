...
/**
 * Created by libra on 16/3/21 上午11:21.
 */
public class ExecutorManager {
    ...
    private static final ThreadFactory eventThreadFactory
            = new ThreadFactory() {
        ...
        public Thread newThread(@NonNull Runnable r) {
            return new Thread(r,
                    "eventAsyncAndBackground #" + mCount.getAndIncrement());
        }
    };
    ...
    static {
        eventExecutor = new ThreadPoolExecutor(CORE_POOL_SIZE,
    ...
    public static int getCountOfCPU() {
        ...
        int count;
        try {
            count = new File("/sys/devices/system/cpu/").listFiles(
                    CPU_FILTER).length;
