package com.libra.muti_image_selector.utils;
...
public class FileUtils {
     ...
     * SD card
     * <i>("/Android/data/[app_package_name]/cache")</i> if card is mounted and
     * app has appropriate permission. Else -
     * Android defines cache directory on device's file system.
     *
     * @param context Application context
     * @return Cache {@link File directory}.<br />
     * <b>NOTE:</b> Can be null in some unpredictable cases (if SD card is
     * unmounted and
     ...
     * SD card
     * <i>("/Android/data/[app_package_name]/cache")</i> (if card is mounted and
     * app has appropriate permission) or
     ...
     * from ImageLoader). Cache directory will be
     * created on SD card <i>("/Android/data/[app_package_name]/cache/uil-images")</i>
     * if card is mounted and app has
    ...
    private static File getExternalCacheDir(Context context) {
        File dataDir = new File(
                ...
                "data");
        File appCacheDir = new File(new File(dataDir, context.getPackageName()),
                "cache");
